...
export const demoInsuranceRevenue = [
  {
    ...
    monthlyPremium: "450",
    status: "received",
    receivedDate: new Date(Date.now() - 60 * 24 * 60 * 60 * 1000).toISOString(),
    notes: "20-year term life policy",
  },
  {
    id: "demo-ins-rev-2",
    ...
    status: "pending",
    receivedDate: null,
    notes: "Whole life with term rider",
  },
  {
    id: "demo-ins-rev-3",
...
export const demoInvestmentRevenue = [
  ...
  },
  {
    id: "demo-inv-rev-3",
    entryType: "dividend",
    clientName: "Chen Corporation",
    ticker: "ZWC.TO",
    accountType: "corporate_cash",
    amount: "680.50",
    status: "pending",
    receivedDate: null,
  },
